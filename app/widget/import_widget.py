...
class ImportSection:
    def __init__(self, master, comunication_section):
        ...
        self.import_title_label.grid(row=0, column=0, columnspan=2, padx=15, pady=10, sticky="nsew")
        ...
        self.import_model_button.grid(row=1, column=0, padx=10, pady=(0,3), sticky="ew")
        ...
        self.import_dataloader_button.grid(row=1, column=1, padx=10, pady=(0,3), sticky="ew")
        ...
        self.import_modelclass_button.grid(row=2, column=0, padx=10, pady=(3,0), sticky="ew")
        ...
        self.import_dataset_button.grid(row=2, column=1, padx=10, pady=(3,0), sticky="ew")
    ...
    def set_threshold_halting_criterion(self, halting_criterion):
        self.threshhold_halting_criterion = halting_criterion
    
    def get_threshold_halting_criterion(self):
        return self.threshhold_halting_criterion
